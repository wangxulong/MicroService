 ...
 */
public class MyRequestList extends BaseAdapter {
    private LayoutInflater mInflater;
    private List<Map<String, Object>> mData;
    public static Map<Integer, Boolean> isSelected;
    public MyRequestList(Context context) {
    ...
    private void init() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            map.put("img", R.drawable.list);
            map.put("title", "       上海大学附近最近的农业银行怎么走？                          2016-02-14");
            mData.add(map);
        }
